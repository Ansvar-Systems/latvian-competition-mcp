...
const TOOLS = [
  {
    ...
    description:
      "Full-text search across CC enforcement decisions (abuse of dominance, cartel, sector inquiries). Returns matching decisions with case number, parties, outcome, fine amount, and GWB articles cited.",
    inputSchema: {
      type: "object" as const,
      properties: {
        query: { type: "string", description: "Search query (e.g., 'dominējošā stāvokļa ļaunprātīga izmantošana, kartelis')" },
        type: {
          type: "string",
  ...
  },
  {
    ...
    description:
      "Get a specific CC decision by case number (e.g., 'B6-22/16').",
    inputSchema: {
      type: "object" as const,
      properties: {
        case_number: { type: "string", description: "Case number (e.g., 'P/04/2023')" },
      },
  ...
  },
  {
    ...
    description:
      "Search CC merger control decisions (Fusionskontrolle).",
    inputSchema: {
      type: "object" as const,
      properties: {
        query: { type: "string", description: "Search query (e.g., 'koncentrācija, iegāde')" },
        sector: { type: "string", description: "Filter by sector ID. Optional." },
        outcome: {
          type: "string",
  ...
  },
  {
    ...
    description:
      "List all sectors with CC enforcement activity, including decision and merger counts.",
      ...
      switch (name) {
        ...
        case "lv_comp_about": {
          return textContent({
            ...
            version: pkgVersion,
            description:
              "CC (German Federal Cartel Office) MCP server. Provides access to German competition law enforcement decisions, merger control cases, and sector enforcement data under the GWB (Gesetz gegen Wettbewerbsbeschränkungen).",
            data_source: "CC (https://www.bundeskartellamt.de/)",
